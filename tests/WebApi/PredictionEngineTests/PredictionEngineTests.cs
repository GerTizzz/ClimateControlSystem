...
namespace ApplicationTests.PredictionEngineTests
{
    ...
    {
        private readonly string[] _lstmInitiateData = {"-13.7;17.91;20",
"-8.4;17.61;18",
"-8.25;16.9;18",
"-8.1;17.25;18",
"-7.95;17.17;18",
...
"-8.17;18.18;18",
        ...
        public async Task CheckPrediction()
        {
            ...
            for (var i = 0; i < _lstmInitiateData.Length; i++)
            {
                var parsedFeatures = _lstmInitiateData[i].Split(";").ToArray();
            ...
            var print = "Температура воздуха внутри ЦОД составит: " +
                        string.Join(" ", prediction.StatefulPartitionedCall) + 
                        Environment.NewLine + 
                        "Исходные данные:" + string.Join(" ",
                        request.serving_default_lstm_input[^3],
                        request.serving_default_lstm_input[^2],
                        request.serving_default_lstm_input[^1]);
