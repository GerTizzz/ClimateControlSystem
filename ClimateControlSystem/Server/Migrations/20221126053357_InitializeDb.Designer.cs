...
namespace ClimateControlSystem.Server.Migrations
{
    ...
    [Migration("20221126053357_InitializeDb")]
            ...
            modelBuilder.Entity("ClimateControlSystem.Server.Resources.RepositoryResources.MonitoringDataRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MeasurementTime = new DateTimeOffset(new DateTime(2022, 11, 26, 10, 33, 57, 102, DateTimeKind.Unspecified).AddTicks(4796), new TimeSpan(0, 5, 0, 0, 0)),
