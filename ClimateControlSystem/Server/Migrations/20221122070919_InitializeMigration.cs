    ...
    public partial class InitializeMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, -3f, 91f, -3.91f, 50.8f, 56f, 5945.632f, 17.7f, new DateTimeOffset(new DateTime(2022, 11, 22, 12, 9, 19, 501, DateTimeKind.Unspecified).AddTicks(2360), new TimeSpan(0, 5, 0, 0, 0)), 18.77f, null, 23.32f, null, 19.71f, 23.48f, 225f, -4.06f, 3f });
